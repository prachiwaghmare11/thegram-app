 ...
 useEffect(()=>{
  ...
  const postData = ()=>{
    ...
    if(!emailRegex.test(email)){
      ...
      return notifyError("Password must contain at least eight characcters, including at least 1 number and 1 includes both lower and uppercase letters and special character")
    }
  ...
  return (
    <div className='signUp'>
      <div className="form-container">
        ...
        <div>
          <input type="email" name="email" id="email" value={email} onChange={(e)=>{setEmail(e.target.value)}} placeholder='Email'></input>
        </div>
        <div>
        ...
        <p className='signUpPara'>
          By signing up, you agree to Terms, <br/> privacy policy and cookies policy. 
        </p>
